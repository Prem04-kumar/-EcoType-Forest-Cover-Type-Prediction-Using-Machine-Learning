...
def load_artifacts():
    model = joblib.load(r"C:\VSCODE\random_forest.pkl")
    selected_features = joblib.load(r"C:\VSCODE\features.pkl")
    label_encoder = joblib.load(r"C:\VSCODE\label_encoder.pkl")
